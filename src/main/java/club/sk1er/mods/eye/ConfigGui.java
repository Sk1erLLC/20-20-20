...
public class ConfigGui extends GuiScreen {
    ...
    public static void drawScaledText(String text, int trueX, int trueY, double scaleFac, int color, boolean shadow, boolean centered) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawString(text, (float) (((double) trueX) / scaleFac) - (centered ? Minecraft.getMinecraft().fontRenderer.getStringWidth(text) / 2 : 0), (float) (((double) trueY) / scaleFac), color, shadow);
